...
async function getMediaData(photographerId, tri){
  ...
  .then(function(objet){
   ...
   if(tri==="titre"){
    ...
    // const titreObj= objet.media.sort(trierParTitre);
    // const popObjet =  objet.media.sort(trierParPopularite);
...
// boutonPopulaire.addEventListener('click', trierMediaPop())

// function trierMediaPop(){
//   boutonDropdown.innerHTML = "Titre";
//   boutonPopulaire.style.display = "none";
//   boutonTitre.style.display = "block";
//   wrapperThumbMedia.innerHTML= "";
//   const filtrer = objet.media.sort(a,b =>{
//     return b.likes -a.likes;
//   })
//   creatMediaGrid(filtrer)
// }
